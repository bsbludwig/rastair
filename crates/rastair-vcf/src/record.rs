...
macro_rules! vcf_record {
    ...
    (
        ...
        pub struct Filters(seqair_types::SmallVec<seqair_types::SmolStr, 8>);

        #[allow(unused)]
        impl Filters {
            pub fn new() -> Self {
                Self(seqair_types::SmallVec::new())
            }

            pub fn add(&mut self, filter: seqair_types::SmolStr) {
                self.0.push(filter);
            }
        ...
        pub struct Record {
            ...
            pub samples: seqair_types::SmallVec<Format, $min_samples>,
        }
